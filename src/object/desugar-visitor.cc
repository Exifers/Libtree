...
#warning // FIXME: Some code was deleted here.
  ...
  {
#warning // FIXME: Some code was deleted here (Check int, then string, then class name).
  }
...
#warning // FIXME: Some code was deleted here (Initialize def).
...
#warning // FIXME: Some code was deleted here (Initialize attr).
...
#warning // FIXME: Some code was deleted here.
                                  ...
                                  const misc::symbol& class_name)
  {
    ...
    // Get the other arguments.
    const ast::MethodDec* def;
#warning // FIXME: Some code was deleted here (Initiliaze def).
    ...
    if (cls->has_data())
      {
        types_
          ...
          << " { ";
#warning // FIXME: Some code was deleted here (Populate the record with attributes (names and types)).
        types_ << " }\n";
      }
...
#warning // FIXME: Some code was deleted here (Get the ty's class type).
...
#warning // FIXME: Some code was deleted here.
    ...
    ast::Var* var = nullptr;
#warning // FIXME: Some code was deleted here (Recurse).
...
#warning // FIXME: Some code was deleted here.
    ...
    const ast::Location& location = e.location_get();
#warning // FIXME: Some code was deleted here (Grab name).

#warning // FIXME: Some code was deleted here (Actual arguments).
...
#warning // FIXME: Some code was deleted here (Instantiate into result).
  }
...
#warning // FIXME: Some code was deleted here (Adapt type).
...
#warning // FIXME: Some code was deleted here (Instanciate into result).
  }
  ...
  {
    bool is_main;
#warning // FIXME: Some code was deleted here (Setup is_main).
    if (is_main)
      {
